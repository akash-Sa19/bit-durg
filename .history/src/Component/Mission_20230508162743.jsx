  ...
  return (
    <div className="custom-cont">
      <div className="bg-bit-red h-[735px] w-full rounded-lg relative">
        <div className="h-[270px] w-[440px] bg-white border-4 border-black rounded- absolute top-[110px] left-[185px] z-10">
          <img
        ...
        <div className="h-[385px] w-[605px] bg-white border-4 border-black rounded- absolute bottom-[110px] right-[185px]">
