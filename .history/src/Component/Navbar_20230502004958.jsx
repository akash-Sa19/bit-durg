...
const Navbar = () => {
  ...
  return (
    <div className="font-roboto">
      <div class="flex gap-4 bg-bit-red h-10">
        <div class="item basis-0 grow">
          <div className="flex items-center h-full justify-end gap-10">
        ...
        <div class="item basis-0 grow">
          <div className={`flex items-center h-full justify-start gap-10`}>
            <Button variant="text" sx={buttonStyle}>
              About
            </Button>
            <Button variant="text" sx={buttonStyle}>
