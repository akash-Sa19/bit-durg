  ...
  return (
    <div className="custom-cont">
      <div
        ...
        sm:h-[550px]"
      >
        <div className="h-[270px] w-[440px] bg-white border-4 border-black rounded-xl absolute top-[10vw] left-[12vw] z-10">
          <img
        ...
        <div className="h-[385px] w-[605px] bg-white border-4 border-black rounded-xl absolute bottom-[10vw] right-[10vw]">
          <img
            src={endDoubleQuote}
            alt="endDoubleQuote"
