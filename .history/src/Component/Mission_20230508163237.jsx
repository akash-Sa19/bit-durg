      ...
      <div className="bg-bit-red h-[735px] w-full rounded-lg relative">
        ...
        <div className="h-[385px] w-[605px] bg-white border-4 border-black rounded-xl absolute bottom-[110px] right-[185px]">
          ...
          >
            ...
            natus perspiciatis modi laboriosam dolor quos harum doloremque optio
            cumque provident id aperiam fugit veniam asperiores. Eaque nam odit
            quaerat eius. Odit optio cupiditate voluptas illo! Deleniti repellat
            veniam facere sit debitis mollitia neque dicta aliquid. Facere
            provident explicabo dolores et in tempora illum. Animi accusantium
            provident voluptates, consequuntur doloremque laborum ullam?
          </Typography>
        </div>
      </div>
    </div>
