    ...
    content: [
      {
        ...
        links: [
          ["About",
            "https://https://bitdurg.ac.in/about.ac.in/"],

          ["Mission",
            "https://bitdurg.ac.in/mission"],

          ["Quality Policy",
            "https://bitdurg.ac.in/mission"],

          ["Visionaries",
            "https://bitdurg.ac.in/chairman-message"],

          ["Principal",
            "https://bitdurg.ac.in/director-message"],
      ...
      },
      {
        ...
        links: [
          ["Audit Report",
            'https://bitdurg.ac.in/audit-report'],

          ["Governance",
            'https://bitdurg.ac.in/governance'],
      ...
      },
      {
        ...
        links: [
          ["Anti Ragging",
            'https://bitdurg.ac.in/anti-ragging'],
    ...
    content: [
      {
        ...
        links: [
          ...
          ["D Link",
            'https://bitdurg.ac.in/dlink'],

          // Empty Link - Down
          ["NMEICT", '#'],

          ["NPTEL",
            'https://bitdurg.ac.in/nptel'],

          ["Spoken Tutorial",
            'https://bitdurg.ac.in/spoken-tutorial'],

          ["Texas Innovation",
            'https://bitdurg.ac.in/texas'],
        ],
        key: 1,
      },
      {
      ...
      },
      {
        ...
        links: [
          ["Faculty Achievements",
            'https://bitdurg.ac.in/faculty'],

          ["Student Achievements",
            'https://bitdurg.ac.in/student'],
      ...
      },
      {
        ...
        links: [
          ...
          ["M.Tech",
            'https://bitdurg.ac.in/pg-programme'],
          ["MCA",
            'https://bitdurg.ac.in/pg-programme#mca'],
          ["MBA",
            'https://bitdurg.ac.in/pg-programme#mba'],
          ["Ph.D",
            'https://bitdurg.ac.in/doctoral-programme'],
          ["B.Voc",
            'https://bitdurg.ac.in/ug-programme#bvoc'],
    ...
    content: [
      {
        ...
        links: [
          ["About T&P",
            'https://bitdurg.ac.in/about-tnp'],

          ["Placement Team",
            'https://bitdurg.ac.in/tnp-team'],

          ["Placement Gallery",
            'https://bitdurg.ac.in/gallery-tnp'],

          ["Contact T&P Cell",
            'https://bitdurg.ac.in/contact-tnp'],
      ...
      },
      {
        ...
        links: [
          ["About BrainTech",
            'https://bitdurg.ac.in/udaan-centre']
        ],
        key: 2,
      },
      {
      ...
      },
      {
        ...
        links: [
          ["Recruiters",
            'https://bitdurg.ac.in/our-recruiter'],
    ...
    content: [
      {
        ...
        links: [
          ["Astro Club",
            'https://bitdurg.ac.in/astro-club'],

          ["Clicks Club",
            'https://bitdurg.ac.in/click-club'],

          ["Techno Hub",
            'https://bitdurg.ac.in/yantra-club'],
          ...
          ["Robotics Club",
            'https://bitdurg.ac.in/robotics-club'],

          ["Vista Club",
            'https://bitdurg.ac.in/vista-club'],

          ["Quizbizz Club",
            'https://bitdurg.ac.in/quizbizz-club'],

          ["Startup Club",
            'https://bitdurg.ac.in/startup-club'],
          ...
          ["Literary Club",
            'https://bitdurg.ac.in/literary_club'],
      ...
      },
      {
        ...
        links: [
          ["Library",
            'https://bitdurg.ac.in/central-library'],

          ["Wifi Campus",
            'https://bitdurg.ac.in/wifi-campus'],

          ["Bank",
            'https://bitdurg.ac.in/bank'],

          ["Medical Facility",
            'https://bitdurg.ac.in/dispensary'],

          ["Shopping Complex",
            'https://bitdurg.ac.in/student-store'],

          ["Gymnasium",
            'https://bitdurg.ac.in/gym'],
      ...
      },
      {
        ...
        links: [
          ["Techfest (OJAS)",
            'https://bitdurg.ac.in/techfest'],

          ["Spicmacy",
            'https://bitdurg.ac.in/spicmacay'],

          ["Hostels",
            'https://bitdurg.ac.in/hostels'],

          ["Sports",
            'https://bitdurg.ac.in/sports'],

          ["NCC",
            'https://bitdurg.ac.in/ncc'],

          ["NSS",
            'https://bitdurg.ac.in/nss'],
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        links: [
          ["Alumni Connect",
            'https://alumni.bitdurg.ac.in/'],

          ["Success Stories",
            'https://bitdurg.ac.in/success-story'],

          ["Testimonial",
            'https://bitdurg.ac.in/testimonials'],
        ],
      ...
      },
      {
        ...
        ["Newsletter", 
        'https://bitdurg.ac.in/news-letter'],
    ...
    content: [
      {
        heading: 'Explore BIT',
        links: [
          ['Blogs At BIT', 'https://bitdurg.ac.in/best-colleges-in-india']
        ]
      }
    ],
    key: 8,
